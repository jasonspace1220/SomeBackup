...
class ContactRecordDepartRepository extends BaseDtRepo
{
    use BasePermission;
 ...
 */
    ...
    public function SpacialQuery()
    {
        ...
        $this->builder->whereIn('c.create_by', $create_bys);//部門的人們
