...
class CustomerRecentRepository extends BaseDtRepo
{
 ...
 */
    ...
    public function SpacialQuery()
    {
        ...
        if($this->allSearch[0] == "1"){
            //近期新增
            $this->builder->whereBetween('first_create_datetime',[$lastMonth,$today]);
        }else{
            //近期更新
            $this->builder->whereBetween('last_update_datetime',[$lastMonth,$today]);
        }
        $this->builder->whereIn('id', $customer_ids);
        return $this->builder;
